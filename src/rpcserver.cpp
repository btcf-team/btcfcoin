...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
   ...
   // { "mining",             "submitblock",            &submitblock,            true,      true,       false },
    ...
    /* Dash features */
    { "BtcfCoin",               "masternode",             &masternode,             true,      true,       false },
    { "BtcfCoin",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "BtcfCoin",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "BtcfCoin",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "BtcfCoin",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "BtcfCoin",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "BtcfCoin",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "BtcfCoin",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
