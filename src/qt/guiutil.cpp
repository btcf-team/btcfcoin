...
{
    QString ret = QString("btcf:%1").arg(info.address);
    int paramCount = 0;
...
void openConfigfile()
{
    ...
    /* Open BtcfCoin.conf with the associated application */
