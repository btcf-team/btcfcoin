...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    homePageAction = new QAction(QIcon(":/icons/overview"), tr("acBtcf"), this);
    homePageAction->setStatusTip(tr("acBtcftips"));
...
{
    QUrl AuthorUrl("http://cn.acBtcf.com");
...
{
    QUrl AuthorUrl("http://block.btfc.cc/");
    QDesktopServices::openUrl(AuthorUrl);
}
